...
<head>
    ...
    <!--引入登入样式-->
	<link rel="stylesheet" type="text/css" href="dist/css/login.W.min.css" />
...
<body>
    ...
    <div class="panel panel-default">
        ...
        <!--密码-->
		  <div class="form-group">
		    ...
		    <input type="password" class="form-control pwdinp" name="password1" id="password1" placeholder="请您输入密码">
		  </div>
	...
	<!-- 引入自定义工具样式 -->
    <script src="dist/js/loginValidator.W.min.js"></script>
    <script>
    	//登录界面小猫的动态交互效果
