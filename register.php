			  ...
			  <div class="form-group">
			    ...
			    <!--确认密码-->
				  <div class="form-group">
				    ...
				    <input type="password" class="form-control" id="password2" placeholder="请您再次输入密码">
				  </div>
			    ...
			    <!--姓名-->
				 ...
				 <!--手机号码-->
				  <div class="form-group">
				    ...
				    <input type="text" class="form-control" id="tel" placeholder="请输入您的手机号码">
				  </div>
			    <!--性别-->
				  <div class="form-group">
                ...
                <div class="checkbox">
				    <label>
				      <input type="checkbox">我已阅读并同意遵守相关协议
				    </label>
				</div>
				  <!--提交按钮-->
